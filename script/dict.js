const characters = [
    { name: "Питер Паркер / Человек-Паук (Том Холланд)", image: "../images/search-items/tomi_1.svg" },
    { name: "Питер Паркер / Человек-Паук (Тоби Магуайр)", image: "../images/search-items/tobi_2.svg" },
    { name: "Питер Паркер / Человек-Паук (Эндрю Гарфилд)", image: "../images/search-items/endry_9.svg" },
    { name: "Зелёный Гоблин / Норман Озборн (Уильям Дефо)", image: "../images/search-items/defo_3.svg" },
    { name: "Мэри Джейн Уотсон (Кирстен Данст)", image: "../images/search-items/danst_4.svg" },
    { name: "Доктор Осьминог / Док Ок (Альфред Молина)", image: "../images/search-items/molino_5.svg" },
    { name: "Веном / Эдди Брок (Тофер Грейс)", image: "./images/search-items/grays_6.svg" },
    { name: "Человек-Песок / Флинт Марко (Томас Хейден Чёрч)", image: "../images/search-items/tomas_7.svg" },
    { name: "Новый Зелёный Гоблин / Гарри Озборн (Джеймс Франко)", image: "../images/search-items/jaaims_8.svg" },
